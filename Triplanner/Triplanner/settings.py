...
SECRET_KEY = "django-insecure-xg-mub-6kz$bj%j_25e1t-mg2ar7%*$blxdk0c+l9!0sc1bvwm"
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,                    # optional, rotates refresh token on refresh
    'BLACKLIST_AFTER_ROTATION': True,                # optional, for logout
